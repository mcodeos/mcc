...
#ifndef YY_MCA_USERS_DAN_WORK_MO_MCAST_SRC_MCA_TAB_H_INCLUDED
# define YY_MCA_USERS_DAN_WORK_MO_MCAST_SRC_MCA_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef MCA_DEBUG
# if defined YYDEBUG
#if YYDEBUG
...
# define MCA_TOKENTYPE
  enum mca_tokentype
  {
    ...
    MCU_CHARGE = 358,              /* MCU_CHARGE  */
    MCUVAL_VOLT = 359,             /* MCUVAL_VOLT  */
    MCUVAL_AMP = 360,              /* MCUVAL_AMP  */
    MCUVAL_CAP = 361,              /* MCUVAL_CAP  */
    ...
    MCUVAL_DB = 369,               /* MCUVAL_DB  */
    MCUVAL_PPM = 370,              /* MCUVAL_PPM  */
    MCUVAL_PERCENT = 371,          /* MCUVAL_PERCENT  */
    MCUVAL_BAUD = 372,             /* MCUVAL_BAUD  */
    MCUVAL_DATASIZE = 373,         /* MCUVAL_DATASIZE  */
    MCUVAL_SPS = 374,              /* MCUVAL_SPS  */
    MCUVAL_SIEMENS = 375,          /* MCUVAL_SIEMENS  */
    MCUVAL_RESPONSIVITY = 376,     /* MCUVAL_RESPONSIVITY  */
    MCUVAL_ANGLE = 377,            /* MCUVAL_ANGLE  */
    MCUVAL_ANGULAR_RATE = 378,     /* MCUVAL_ANGULAR_RATE  */
    MCUVAL_ENERGY = 379,           /* MCUVAL_ENERGY  */
    MCUVAL_EFIELD = 380,           /* MCUVAL_EFIELD  */
    MCUVAL_HFIELD = 381,           /* MCUVAL_HFIELD  */
    MCUVAL_FLUX = 382,             /* MCUVAL_FLUX  */
    MCUVAL_BFIELD = 383,           /* MCUVAL_BFIELD  */
    MCUVAL_SLEW = 384,             /* MCUVAL_SLEW  */
    MCUVAL_NOISE = 385,            /* MCUVAL_NOISE  */
    MCUVAL_CHARGE = 386,           /* MCUVAL_CHARGE  */
    MC_WS = 387,                   /* MC_WS  */
    MC_SINGLE_COMMENT = 388,       /* MC_SINGLE_COMMENT  */
    MC_MULTI_COMMENT = 389         /* MC_MULTI_COMMENT  */
  };
...
#endif /* !YY_MCA_USERS_DAN_WORK_MO_MCAST_SRC_MCA_TAB_H_INCLUDED  */
