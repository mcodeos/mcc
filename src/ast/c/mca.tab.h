...
# define MCA_TOKENTYPE
  enum mca_tokentype
  {
    ...
    MCK_ANL = 319,                 /* MCK_ANL  */
    MCK_NC = 320,                  /* MCK_NC  */
    MCONST_HIGH = 321,             /* MCONST_HIGH  */
    MCONST_LOW = 322,              /* MCONST_LOW  */
    MCONST_NC = 323,               /* MCONST_NC  */
    MCU_INT = 324,                 /* MCU_INT  */
    MCU_HEX = 325,                 /* MCU_HEX  */
    MCU_FLOAT = 326,               /* MCU_FLOAT  */
    MCU_STRING = 327,              /* MCU_STRING  */
    MCK_FUNC = 328,                /* MCK_FUNC  */
    MCK_THIS = 329,                /* MCK_THIS  */
    MCU_VOLT = 330,                /* MCU_VOLT  */
    MCU_AMP = 331,                 /* MCU_AMP  */
    MCU_CAP = 332,                 /* MCU_CAP  */
    MCU_IND = 333,                 /* MCU_IND  */
    MCU_TIME = 334,                /* MCU_TIME  */
    MCU_LEN = 335,                 /* MCU_LEN  */
    MCU_WAT = 336,                 /* MCU_WAT  */
    MCU_OHM = 337,                 /* MCU_OHM  */
    MCU_TEMP = 338,                /* MCU_TEMP  */
    MCU_HZ = 339,                  /* MCU_HZ  */
    MCU_DB = 340,                  /* MCU_DB  */
    MCU_PPM = 341,                 /* MCU_PPM  */
    MCU_PERCENT = 342,             /* MCU_PERCENT  */
    MCU_BAUD = 343,                /* MCU_BAUD  */
    MCU_DATASIZE = 344,            /* MCU_DATASIZE  */
    MCU_SPS = 345,                 /* MCU_SPS  */
    MCU_SIEMENS = 346,             /* MCU_SIEMENS  */
    MCU_RESPONSIVITY = 347,        /* MCU_RESPONSIVITY  */
    MCU_ANGLE = 348,               /* MCU_ANGLE  */
    MCU_ANGULAR_RATE = 349,        /* MCU_ANGULAR_RATE  */
    MCU_ENERGY = 350,              /* MCU_ENERGY  */
    MCU_EFIELD = 351,              /* MCU_EFIELD  */
    MCU_HFIELD = 352,              /* MCU_HFIELD  */
    MCU_FLUX = 353,                /* MCU_FLUX  */
    MCU_BFIELD = 354,              /* MCU_BFIELD  */
    MCU_SLEW = 355,                /* MCU_SLEW  */
    MCU_NOISE = 356,               /* MCU_NOISE  */
    MCUVAL_VOLT = 357,             /* MCUVAL_VOLT  */
    MCUVAL_AMP = 358,              /* MCUVAL_AMP  */
    MCUVAL_CAP = 359,              /* MCUVAL_CAP  */
    MCUVAL_IND = 360,              /* MCUVAL_IND  */
    MCUVAL_TIME = 361,             /* MCUVAL_TIME  */
    MCUVAL_LEN = 362,              /* MCUVAL_LEN  */
    MCUVAL_WAT = 363,              /* MCUVAL_WAT  */
    MCUVAL_OHM = 364,              /* MCUVAL_OHM  */
    MCUVAL_TEMP = 365,             /* MCUVAL_TEMP  */
    MCUVAL_HZ = 366,               /* MCUVAL_HZ  */
    MCUVAL_DB = 367,               /* MCUVAL_DB  */
    MCUVAL_PPM = 368,              /* MCUVAL_PPM  */
    MCUVAL_PERCENT = 369,          /* MCUVAL_PERCENT  */
    MCUVAL_BAUD = 370,             /* MCUVAL_BAUD  */
    MCUVAL_DATASIZE = 371,         /* MCUVAL_DATASIZE  */
    MCUVAL_SPS = 372,              /* MCUVAL_SPS  */
    MCUVAL_SIEMENS = 373,          /* MCUVAL_SIEMENS  */
    MCUVAL_RESPONSIVITY = 374,     /* MCUVAL_RESPONSIVITY  */
    MCUVAL_ANGLE = 375,            /* MCUVAL_ANGLE  */
    MCUVAL_ANGULAR_RATE = 376,     /* MCUVAL_ANGULAR_RATE  */
    MCUVAL_ENERGY = 377,           /* MCUVAL_ENERGY  */
    MCUVAL_EFIELD = 378,           /* MCUVAL_EFIELD  */
    MCUVAL_HFIELD = 379,           /* MCUVAL_HFIELD  */
    MCUVAL_FLUX = 380,             /* MCUVAL_FLUX  */
    MCUVAL_BFIELD = 381,           /* MCUVAL_BFIELD  */
    MCUVAL_SLEW = 382,             /* MCUVAL_SLEW  */
    MCUVAL_NOISE = 383,            /* MCUVAL_NOISE  */
    MC_WS = 384,                   /* MC_WS  */
    MC_SINGLE_COMMENT = 385,       /* MC_SINGLE_COMMENT  */
    MC_MULTI_COMMENT = 386         /* MC_MULTI_COMMENT  */
  };
