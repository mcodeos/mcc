...
# define MCA_TOKENTYPE
  enum mca_tokentype
  {
    ...
    MCOP_OR = 304,                 /* MCOP_OR  */
    MCOP_MULTI = 305,              /* MCOP_MULTI  */
    MCOP_DIVID = 306,              /* MCOP_DIVID  */
    MCOP_CARET = 307,              /* MCOP_CARET  */
    MCOP_APOST = 308,              /* MCOP_APOST  */
    MCPT_LBRACKET = 309,           /* MCPT_LBRACKET  */
    MCPT_RBRACKET = 310,           /* MCPT_RBRACKET  */
    MCPT_LPAREN = 311,             /* MCPT_LPAREN  */
    MCPT_RPAREN = 312,             /* MCPT_RPAREN  */
    MCOP_TILDE = 313,              /* MCOP_TILDE  */
    MCOP_PLUSMINUS = 314,          /* MCOP_PLUSMINUS  */
    MCPT_DBCOLON = 315,            /* MCPT_DBCOLON  */
    MCK_ELSE_IF = 316,             /* MCK_ELSE_IF  */
    MCK_ELSE = 317,                /* MCK_ELSE  */
    MCK_IF = 318,                  /* MCK_IF  */
    MC_ENDL = 319,                 /* MC_ENDL  */
    MCK_RETURN = 320,              /* MCK_RETURN  */
    MCK_IO = 321,                  /* MCK_IO  */
    MCK_IN = 322,                  /* MCK_IN  */
    MCK_OUT = 323,                 /* MCK_OUT  */
    MCK_ANL = 324,                 /* MCK_ANL  */
