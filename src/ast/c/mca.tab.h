...
# define MCA_TOKENTYPE
  enum mca_tokentype
  {
    ...
    MCK_OVERLAY = 289,             /* MCK_OVERLAY  */
    MCOP_EQUAL = 290,              /* MCOP_EQUAL  */
    MCK_PINS = 291,                /* MCK_PINS  */
    MCOP_PLUSEQUAL = 292,          /* MCOP_PLUSEQUAL  */
    MCOP_EQUALEQUAL = 293,         /* MCOP_EQUALEQUAL  */
    MCOP_NOTEQUAL = 294,           /* MCOP_NOTEQUAL  */
    MCOP_LESSTHAN = 295,           /* MCOP_LESSTHAN  */
    MCOP_GREATERTHAN = 296,        /* MCOP_GREATERTHAN  */
    MCOP_LESSEQTHAN = 297,         /* MCOP_LESSEQTHAN  */
    MCOP_GREATEREQTHAN = 298,      /* MCOP_GREATEREQTHAN  */
    MCOP_DOUBLEARROW = 299,        /* MCOP_DOUBLEARROW  */
    MCOP_LEFTARROW = 300,          /* MCOP_LEFTARROW  */
    MCOP_RIGHTARROW = 301,         /* MCOP_RIGHTARROW  */
    MCOP_PLUS = 302,               /* MCOP_PLUS  */
    MCOP_MINUS = 303,              /* MCOP_MINUS  */
    MCOP_AND = 304,                /* MCOP_AND  */
    MCOP_OR = 305,                 /* MCOP_OR  */
    MCOP_ANDAND = 306,             /* MCOP_ANDAND  */
    MCOP_OROR = 307,               /* MCOP_OROR  */
    MCOP_MULTI = 308,              /* MCOP_MULTI  */
    MCOP_DIVID = 309,              /* MCOP_DIVID  */
    MCOP_CARET = 310,              /* MCOP_CARET  */
    MCOP_APOST = 311,              /* MCOP_APOST  */
    MCPT_LBRACKET = 312,           /* MCPT_LBRACKET  */
    MCPT_RBRACKET = 313,           /* MCPT_RBRACKET  */
    MCPT_LPAREN = 314,             /* MCPT_LPAREN  */
    MCPT_RPAREN = 315,             /* MCPT_RPAREN  */
    MCOP_TILDE = 316,              /* MCOP_TILDE  */
    MCOP_PLUSMINUS = 317,          /* MCOP_PLUSMINUS  */
    MCOP_TIMES = 318,              /* MCOP_TIMES  */
    MCPT_DBCOLON = 319,            /* MCPT_DBCOLON  */
    MCK_ELSE_IF = 320,             /* MCK_ELSE_IF  */
    MCK_ELSE = 321,                /* MCK_ELSE  */
    MCK_IF = 322,                  /* MCK_IF  */
    MC_ENDL = 323,                 /* MC_ENDL  */
    MCK_RETURN = 324,              /* MCK_RETURN  */
    MCK_ERROR = 325,               /* MCK_ERROR  */
    MCK_IO = 326,                  /* MCK_IO  */
    MCK_IN = 327,                  /* MCK_IN  */
    MCK_OUT = 328,                 /* MCK_OUT  */
    MCK_NC = 329,                  /* MCK_NC  */
