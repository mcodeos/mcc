...
impl RenderedConnectivityReport {
    ...
    pub fn from_connectivity(conn: &RenderedConnectivity) -> Self {
        ...
        // ★ P7-3: a pin with a terminal decoration (ground symbol / rail dot)
        // has no wire segment, but the symbol is the connection — count it
        // reachable and never report it as unreachable.
