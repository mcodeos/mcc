...
pub static FLAT_ERC_RULES: &[FlatErcRule] = &[
    ...
    // BOM overlay binds (param-authoring-design.md section 4, U245)
    declare_flat_erc_rule! {
        code = crate::errcodes::BOM_OVERLAY_VALUE_NOT_DESCENDANT,
        name = "overlay-value-descendant",
        title = "overlay value is not a variant of the slot class",
        severity = Error,
        domain = Structure,
        family = None,
        doc = "A bom.overlay.toml value names a class that is not a `:` descendant of the slot's declared class.",
        lock = "tests/shard6/bom_overlay_binding.rs",
        overridable = false,
        owner = check_overlay_value_descendant,
    },
    declare_flat_erc_rule! {
        code = crate::errcodes::BOM_OVERLAY_KEY_NOT_SLOT,
        name = "overlay-key-slot",
        title = "overlay key does not designate an abstract slot",
        severity = Error,
        domain = Structure,
        family = None,
        doc = "A bom.overlay.toml key does not designate an abstract-declared instance.",
        lock = "tests/shard6/bom_overlay_binding.rs",
        overridable = false,
        owner = check_overlay_key_slot,
    },
