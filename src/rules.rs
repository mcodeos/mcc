...
pub static FLAT_ERC_RULES: &[FlatErcRule] = &[
    ...
    declare_flat_erc_rule! {
        ...
        domain = Structure,
        family = None,
        doc = "A bom.overlay.mc value names a class that is not a `:` descendant of the slot's declared class.",
    ...
    declare_flat_erc_rule! {
        ...
        domain = Structure,
        family = None,
        doc = "A bom.overlay.mc key does not designate an abstract-declared instance.",
        lock = "tests/shard6/bom_overlay_binding.rs",
        overridable = false,
