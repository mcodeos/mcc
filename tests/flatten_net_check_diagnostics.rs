...
/// `use ./defs.mc` resolves against the real file system, so
...
/// instead of file:1:1. A′-scope routes module-boundary ports to C4. The empty
/// US513 body also emits 2115; only the 4114 entries are
/// asserted here.
///
...
/// to C4), anchored at the `io MIC{P,N}` declaration (pos 20)
/// instead of file:1:1.
#[test]
